    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><b>Online Quiz System</b></a>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if (@$_GET['q'] == 1) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        if ($rowcount == 0) {
                            ...
                            // Make the "Restart" button redirect to the "Start" button URL
                            echo '<tr style="color:#99cc32"><td><center>' . $c++ . '</center></td><td><center>' . $title . '&nbsp;<span title="This quiz is already solved by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></center></td><td><center>' . $total . '</center></td><td><center>' . $sahi * $total . '</center></td><td><center><b><a href="welcome.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '" class="pull-right btn sub1" style="color:black;margin:0px;background:red"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Restart</b></span></a></b></center></td></tr>';
                        }
                    }
                    $c = 0;
                    echo '</table></div></div>';
                ...
                if (@$_GET['q'] == 3) {
                    // Perform a single query to retrieve data from both 'rank' and 'user' tables using a JOIN
                    $q = mysqli_query($con, "SELECT rank.email, rank.score, user.name FROM rank JOIN user ON rank.email = user.email ORDER BY rank.score DESC") or die('Error223');
        ...
        <tr style="color:red"><td><center><b>Rank</b></center></td><td><center><b>Name</b></center></td><td><center><b>Email</b></center></td><td><center><b>Score</b></center></td></tr>';
                    ...
                    while ($row = mysqli_fetch_array($q)) {
                        ...
                        echo '<tr><td><center>' . $c . '</center></td><td><center>' . $name . '</center></td><td><center>' . $e . '</center></td><td><center>' . $s . '</center></td></tr>';
                    }
